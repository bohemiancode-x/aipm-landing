        ...
        <div className="embla__container flex">
          {expertsData && expertsData.map((resource, index) => (
            <div className="embla__slide relative flex-[0_0_85%] sm:flex-[0_0_65%] md:flex-[0_0_48.3%] lg:flex-[0_0_40.3%] xl:flex-[0_0_38%]" key={index}>
                ...
                <div className='text-white text-[14px] md:text-[20px] absolute bottom-7 left-14'>
                    {/* {companySvg} */}
                    <Image src={resource.coyLogo} width={500} height={0} className='w-[53.7px] md:w-fit' alt='logo' />
                    <p className='mt-3 md:mt-5'>{resource.name}</p>
                    <p>{resource.title}</p>
                </div>
            </div>
          ))}
